...
export default function IbadanHeritageClient() {
  return (
    <section className="bg-[#f8f5f0] py-20 px-6 md:px-16">
      {/* Header Section */}
      <div className="max-w-6xl mx-auto text-center mb-12">
        <h1 className={`${playfair.className} text-3xl md:text-5xl font-bold text-gray-900`}>
          The Heritage of Ibadan
        </h1>
        <p className={`${poppins.className} text-gray-700 text-lg mt-4 max-w-3xl mx-auto`}>
      ...
      <div className="flex flex-col md:flex-row items-center gap-10 mb-20">
        ...
        >
          <div className="relative w-full h-[350px] md:h-[450px] rounded-lg overflow-hidden shadow-lg">
            <Image src="/ibadan.jpg" alt="Ibadan City skyline" fill className="object-cover" />
          </div>
        </motion.div>
        ...
        >
          <h2 className={`${playfair.className} text-2xl md:text-3xl font-semibold mb-4 text-gray-900`}>
            A Brief History of Ibadan
          </h2>
          <p className={`${poppins.className} text-gray-700 text-lg leading-relaxed mb-6`}>
      ...
      <div className="flex flex-col md:flex-row-reverse items-center gap-10 mb-20">
        ...
        >
          <div className="relative w-full h-[350px] md:h-[450px] rounded-lg overflow-hidden shadow-lg">
            <Image src="/royal_palace.jpeg" alt="Olubadan Palace" fill className="object-cover" />
          </div>
        </motion.div>
      ...
      <div className="flex flex-col md:flex-row items-center gap-10 mb-20">
        ...
        >
          <div className="relative w-full h-[350px] md:h-[450px] rounded-lg overflow-hidden shadow-lg">
            <Image src="/royal_festival.jpeg" alt="Ibadan traditional festival" fill className="object-cover" />
          </div>
        </motion.div>
      ...
      <div className="max-w-4xl mx-auto text-center mt-20">
        <h2 className={`${playfair.className} text-2xl md:text-3xl font-semibold mb-6 text-gray-900`}>
        ...
        <ul className={`${poppins.className} text-gray-800 text-lg grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3`}>
          <li>Ibadan North</li>
