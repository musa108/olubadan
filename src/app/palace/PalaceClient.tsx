...
export default function PalaceClient() {
  return (
    <section className="bg-[#f8f5f0] py-20 px-6 md:px-16">
      <div className="max-w-6xl mx-auto text-center mb-12">
        ...
        <p className={`${poppins.className} text-gray-700 text-lg mt-4 max-w-3xl mx-auto`}>
          The Olubadan Palace, known as <em>Ile Olubadan</em>, is not just the seat of
